...
def main():
    ...
    inside the StreamPETR project directory. It passes along all arguments.
    """
    parser = argparse.ArgumentParser(description="Runpod StreamPETR Inference Wrapper")
    ...
    demo_script_path = '/app/StreamPETR/tools/demo.py'
