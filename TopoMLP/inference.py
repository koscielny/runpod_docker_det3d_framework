...
def main():
    ...
    inside the TopoMLP project directory. It passes along all arguments.
    """
    parser = argparse.ArgumentParser(description="Runpod TopoMLP Inference Wrapper")
    ...
    demo_script_path = '/app/TopoMLP/tools/demo.py'
