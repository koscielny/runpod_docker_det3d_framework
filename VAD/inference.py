...
def main():
    ...
    inside the VAD project directory. It passes along all arguments.
    """
    parser = argparse.ArgumentParser(description="Runpod VAD Inference Wrapper")
    ...
    demo_script_path = '/app/VAD/tools/demo.py'
